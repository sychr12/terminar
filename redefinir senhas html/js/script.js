...
function validarNomeUsuarioInput(event) {
    ...
    if (!validarNomeUsuario(usuario.value)) {
        document.getElementById("usuarioErro").innerText = "O nome de usuário deve conter apenas letras minúsculas e pontos.";
        document.getElementById("usuarioErro").style.display = "block";
...
function trocarSenha() {
    ...
    if (valid) {
        ...
        document.querySelector('button[onclick="limparCampos()"]').style.display = "none";
